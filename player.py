...
class Batter:
    def __init__(self,name,type,orientation,batting_power,role):
        ...
        self.type = type
        self.initial_stance = [pygame.transform.scale(pygame.image.load("./Images/initialstance2.png"),(200,275)),
                               pygame.transform.scale(pygame.image.load("./Images/initialstance1.png"),(200,275))
                               ]
